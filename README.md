 ...
 **Example (on a Windows computer):**
 ...
 ### Future Scope
 This app still cannot bypass Cloudflare's Under Attack Mode (advanced DDoS protection). I'll revisit this in future and try to figure out a solution.
